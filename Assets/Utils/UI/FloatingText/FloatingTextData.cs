...
namespace TirexGame.Utils.UI
{
    ...
    public class FloatingTextData : ScriptableObject
    {
        ...
        /// <summary>
        /// Create default damage text configuration
        /// </summary>
        public static FloatingTextData CreateDamageDefault()
        {
            ...
            data.RandomAngle = 20f;
            data.FontSize = 48f;
            data.TextColor = Color.red;
            data.FontStyle = FontStyles.Bold;
            data.ScaleCurve = AnimationCurve.EaseInOut(0, 1.2f, 1, 0.8f);
            data.AlphaCurve = AnimationCurve.EaseInOut(0, 1, 1, 0);
            return data;
        }

        /// <summary>
        /// Create default healing text configuration
        /// </summary>
        public static FloatingTextData CreateHealingDefault()
        {
            ...
            data.MoveSpeed = 2f;
            data.Lifetime = 1.5f;
            data.RandomizeDirection = false;
            data.FontSize = 40f;
            data.TextColor = Color.green;
            data.FontStyle = FontStyles.Normal;
        ...
        /// <summary>
        /// Create default critical hit text configuration
        /// </summary>
        public static FloatingTextData CreateCriticalDefault()
        {
            ...
            data.FontSize = 60f;
            data.TextColor = new Color(1f, 0.5f, 0f); // Orange
            data.FontStyle = FontStyles.Bold;
            data.ScaleCurve = AnimationCurve.EaseInOut(0, 1.5f, 1, 0.7f);
            data.AlphaCurve = AnimationCurve.EaseInOut(0, 1, 1, 0);
            return data;
        }
    }
